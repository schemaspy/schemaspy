...
ALTER TYPE public.mpaa_rating OWNER TO test;
...
ALTER DOMAIN public.year OWNER TO test;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO test;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO test;


COMMENT ON FUNCTION public.film_in_stock (integer, integer, OUT integer) IS 'Current stock';
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO test;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO test;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO test;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO test;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO test;
...
ALTER FUNCTION public.last_updated() OWNER TO test;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO test;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO test;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO test;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO test;
...
ALTER TABLE public.actor OWNER TO test;
...
ALTER TABLE public.category_category_id_seq OWNER TO test;
...
ALTER TABLE public.film_film_id_seq OWNER TO test;
...
ALTER TABLE public.film OWNER TO test;
...
ALTER TABLE public.film_actor OWNER TO test;
...
ALTER TABLE public.film_category OWNER TO test;
...
ALTER TABLE public.actor_info OWNER TO test;
...
ALTER TABLE public.address_address_id_seq OWNER TO test;
...
ALTER TABLE public.address OWNER TO test;
...
ALTER TABLE public.city_city_id_seq OWNER TO test;
...
ALTER TABLE public.city OWNER TO test;
...
ALTER TABLE public.country_country_id_seq OWNER TO test;
...
ALTER TABLE public.country OWNER TO test;
...
ALTER TABLE public.customer_list OWNER TO test;
...
ALTER TABLE public.film_list OWNER TO test;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO test;
...
ALTER TABLE public.inventory OWNER TO test;
...
ALTER TABLE public.language_language_id_seq OWNER TO test;
...
ALTER TABLE public.language OWNER TO test;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO test;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO test;
...
ALTER TABLE public.payment OWNER TO test;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO test;
...
ALTER TABLE public.rental OWNER TO test;
...
ALTER TABLE public.sales_by_film_category OWNER TO test;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO test;
...
ALTER TABLE public.staff OWNER TO test;
...
ALTER TABLE public.store_store_id_seq OWNER TO test;
...
ALTER TABLE public.store OWNER TO test;
...
ALTER TABLE public.sales_by_store OWNER TO test;
...
ALTER TABLE public.staff_list OWNER TO test;
...
--
-- SchemaSpy Check constraint for test
--


CREATE TABLE cctest (ctype text);
ALTER TABLE public.cctest  ADD CONSTRAINT cctest_ctype_cc CHECK (ctype IN ('street', 'road', 'place'));
