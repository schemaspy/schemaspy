...
public class MysqlHTMLIT {
	...
	private static URL expectedXML = MysqlHTMLIT.class
			.getResource("/integrationTesting/mysql/expecting/mysqlhtml/htmlit.htmlit.xml");
	private static URL expectedDeletionOrder = MysqlHTMLIT.class
			.getResource("/integrationTesting/mysql/expecting/mysqlhtml/deletionOrder.txt");
	private static URL expectedInsertionOrder = MysqlHTMLIT.class
			.getResource("/integrationTesting/mysql/expecting/mysqlhtml/insertionOrder.txt");
