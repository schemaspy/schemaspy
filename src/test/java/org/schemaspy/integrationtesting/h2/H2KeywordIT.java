...
public class H2KeywordIT {
	...
	@ClassRule
	public static H2MemoryRule h2MemoryRule = new H2MemoryRule("h2keyword")
	...
	private void doCreateDatabaseRepresentation() throws SQLException, IOException {
		String[] args = { "-t", "src/test/resources/integrationTesting/dbTypes/h2memory", "-db", "h2keyword", "-s",
				"h2keyword", "-o", "target/testout/integrationtesting/h2/keyword", "-u", "sa" };
