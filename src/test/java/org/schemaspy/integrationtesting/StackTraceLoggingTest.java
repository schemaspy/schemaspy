...
@ContextConfiguration(classes = {Main.class, StackTraceLoggingTest.StackTraceLoggingConfiguration.class},
        initializers = {ConfigFileApplicationContextInitializer.class, LogLevelConditionalThrowableProxyConverter.class})
