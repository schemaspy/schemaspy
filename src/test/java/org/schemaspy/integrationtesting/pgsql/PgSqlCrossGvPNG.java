...
public class PgSqlCrossGvPNG {
	...
	private static URL expectedXML = PgSqlCrossGvPNG.class
			.getResource("/integrationTesting/pgsql/expecting/cross_gv_png/htmlit.htmlit.xml");
	private static URL expectedDeletionOrder = PgSqlCrossGvPNG.class
			.getResource("/integrationTesting/pgsql/expecting/cross_gv_png/deletionOrder.txt");
	private static URL expectedInsertionOrder = PgSqlCrossGvPNG.class
			.getResource("/integrationTesting/pgsql/expecting/cross_gv_png/insertionOrder.txt");
	...
	public synchronized void generateHTML() throws Exception {
		if (shouldRun.get()) {
			String[] args = { "-t", "pgsql", "-db", "test", "-all", "-schemaSpec", "sch(a|b)", "-cat", "%", "-o",
