...
public class SchemaMetaIT {
    ...
    public void commentsNullTableComment() throws Exception {
        ...
        new DatabaseServiceFactory(sqlService).simple(config).gatherSchemaDetails(config, databaseWithSchemaMeta, schemaMeta, progressListener);
    ...
    public void commentsAreReplacedWithReplaceComments() throws Exception {
        ...
        new DatabaseServiceFactory(sqlService).simple(config).gatherSchemaDetails(config, database, schemaMeta, progressListener);
