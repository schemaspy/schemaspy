...
public class MustacheSummaryDiagramFactoryTest {
    ...
    public void noDiagrams() throws IOException {
        ...
        MustacheSummaryDiagramFactory mustacheSummaryDiagramFactory = new MustacheSummaryDiagramFactory(dotProducer, mustacheDiagramFactory,false,false, temporaryFolder.newFolder("noDiagrams"), progressListener);
    ...
    public void realDiagrams() throws IOException {
        ...
        SummaryDiagram mustacheDiagramFactory = mock(SummaryDiagram.class);
        when(mustacheDiagramFactory.generateSummaryDiagram(any(File.class),anyString())).then(invocation -> mock(DiagramResult.class));
        MustacheSummaryDiagramFactory mustacheSummaryDiagramFactory = new MustacheSummaryDiagramFactory(dotProducer, mustacheDiagramFactory, true,false, temporaryFolder.newFolder("noDiagrams"), progressListener);
    ...
    public void realAndImpliedDiagrams() throws IOException {
        ...
        MustacheSummaryDiagramFactory mustacheSummaryDiagramFactory = new MustacheSummaryDiagramFactory(dotProducer, mustacheDiagramFactory, true,true, temporaryFolder.newFolder("noDiagrams"), progressListener);
    ...
    public void exceptionsAreCaught() throws IOException {
        ...
        MustacheSummaryDiagramFactory mustacheSummaryDiagramFactory = new MustacheSummaryDiagramFactory(mock(DotFormatter.class),  mustacheDiagramFactory, true,true, outputDir, progressListener);
